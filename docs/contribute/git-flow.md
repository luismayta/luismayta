<!-- Space: Projects -->
<!-- Parent: LuisMayta -->
<!-- Title: Contributing GitFlow LuisMayta -->
...
To contribute to luismayta project on [GitHub](https://github.com/luismayta/luismayta), We use Gitflow (See more [here](https://datasift.github.io/gitflow/IntroducingGitFlow.html)) In a nutshell, it means that you should branch from the main repository and contribute back by making [pull request](https://github.com/luismayta/luismayta/pulls).

![workflow gitflow](https://datasift.github.io/gitflow/GitFlowHotfixBranch.png)

## Getting started

To follow the instructions in this guide and start contributing to luismayta project on Gitlab:
...
```bash
git remote add upstream  https://github.com/luismayta/luismayta.git
```

Now your **upstream** points to **luismayta/luismayta**.
...
git fetch upstream # assuming upstream is luismayta/luismayta
...
All merge requests are automatically tested using [Github Actions](https://github.com/luismayta/luismayta/actions). In case some tests fail, fix the issues or describe why the fix cannot be done.
