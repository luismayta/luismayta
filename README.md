...
- [hadenlabs/action-pre-commit](https://github.com/hadenlabs/action-pre-commit) ([0.1.3](https://github.com/hadenlabs/action-pre-commit/releases/tag/0.1.3), 1 day ago) - Contains our custom action for running pre-commit
