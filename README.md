...
- [hadenlabs/terraform-github-repository](https://github.com/hadenlabs/terraform-github-repository) ([0.11.0](https://github.com/hadenlabs/terraform-github-repository/releases/tag/0.11.0), 3 days ago) - github repository for terraform
- [hadenlabs/action-pre-commit](https://github.com/hadenlabs/action-pre-commit) ([0.1.4](https://github.com/hadenlabs/action-pre-commit/releases/tag/0.1.4), 4 days ago) - Contains our custom action for running pre-commit
