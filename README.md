...
- [hadenlabs/action-pre-commit](https://github.com/hadenlabs/action-pre-commit) ([0.1.1](https://github.com/hadenlabs/action-pre-commit/releases/tag/0.1.1), 2 weeks ago) - Contains our custom action for running pre-commit
