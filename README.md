...
- [hadenlabs/action-pre-commit](https://github.com/hadenlabs/action-pre-commit) ([0.1.8](https://github.com/hadenlabs/action-pre-commit/releases/tag/0.1.8), today) - Contains our custom action for running pre-commit
